...
# Base directories
base_starting_solution_dir = os.path.join("..", "starting_solution", "TSP", "Berlin52")
base_history_dir = os.path.join("..", "history", "PSO", "tsp", "Berlin52", "QuasiRandom")
...
# Base directories
base_starting_solution_dir = os.path.join("..", "starting_solution", "TSP", "Berlin52")
base_history_dir = os.path.join("..", "history", "PSO", "tsp", "Berlin52", "BeamSplitter")
...
# Base directories
base_starting_solution_dir = os.path.join("..", "starting_solution", "TSP", "Bier127")
base_history_dir = os.path.join("..", "history", "PSO", "tsp", "Bier127", "BeamSplitter")
